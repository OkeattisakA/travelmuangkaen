...
class PlacephotoController extends Controller
{
    ...
    public function create($place_id)
    {
        ...
        return view('admin.placephotos.create',compact('place','placephotos'));
    }

    public function createstep($place_id)
    {
        $place = Place::find($place_id);
        $placephotos = Placephoto::where('place_id',$place_id)->get();
        return view('admin.placephotos.createstep',compact('place','placephotos'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($file = $request->file('placephotos')){
            ...
            return redirect("admin/placephotos/create/".$input['place_id']."");
        }else{
    ...
    public function destroy(Request $request,$placephoto_id)
    {
        ...
        return redirect("admin/placephotos/create/".$place_id."");
    }
