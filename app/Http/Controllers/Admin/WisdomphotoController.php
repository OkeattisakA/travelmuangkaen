...
class WisdomphotoController extends Controller
{
    ...
    public function create($wisdom_id)
    {
        ...
        return view('admin.wisdomphotos.create',compact('wisdom','wisdomphotos'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($file = $request->file('wisdomphotos')){
            ...
            return redirect("admin/wisdomphotos/create/".$input['wisdom_id']."");
        }else{
    ...
    public function destroy(Request $request,$wisdomphoto_id)
    {
        ...
        return redirect("admin/wisdomphotos/create/".$wisdom_id."");
    }
}
