...
@section('content')
    ...
    {{--<div class="card">--}}
    {{--<div class="card-body">--}}
    {{--<div class="fb-page" data-href="https://www.facebook.com/GoodNightPillow/" data-tabs="timeline" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/GoodNightPillow/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/GoodNightPillow/">หมอนฝันดี</a></blockquote></div>--}}
    {{--</div>--}}
    {{--</div>--}}
    {{--</div>--}}
    {{--</div>--}}
                                    ...
                                    {{--<div class="post-module">--}}
                                        ...
                                        {{--<a href="{{ url("places/{$place->place_id}") }}">--}}
                                            ...
                                            {{--<div class="post-content">--}}
                                                ...
                                                {{--<div class="post-meta"><small class="text-muted">{{ $place->updated_at }}</small></div>--}}
                                            {{--</div>--}}
                                        {{--</a>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <input type="text" class="form-control input-lg" id="search" autocomplete="off" v-model="search" placeholder="ค้นหาสถานที่ท่องเที่ยว">
