...
@section('title','เพิ่มข้อมูลภูมิปัญญาท้องถิ่น')
@section('content')
    <br>
    ...
    <div class="card">
        <div class="card-header">
            <strong>เพิ่มข้อมูลภูมิปัญญาท้องถิ่น</strong>
        </div>
        <div class="card-body">
            {!! Form::open(['id' => 'wisdomCreate','url' => 'member/wisdoms','files' => true]) !!}
            ...
            <div class="form-group">
                {!! Form::submit('เพิ่มข้อมูลภูมิปัญญาท้องถิ่น',['class'=>'btn btn-primary']) !!}
            </div>
