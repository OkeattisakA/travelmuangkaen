        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="pull-right"><a href="{{ url("member/wisdoms/{$wisdom->wisdom_id}/edit") }}" class="btn btn-info"><i class="fa fa-edit" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="แก้ไข"></i></a></div>
