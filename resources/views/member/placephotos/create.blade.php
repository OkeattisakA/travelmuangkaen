...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ url('member/placephotos') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                        ...
                        <div class="col-md-3">
                            ...
                            <div align="center">
                                ...
                                <p align="center">
                                    ...
                                    {!! Form::open(['method' => 'DELETE','action' => ['Member\PlacephotoController@destroy',$placephoto->placephoto_id]]) !!}
                                    {{ Form::hidden('place_id', $place->place_id) }}
    ...
    <div class="text-right">
        <a href="{{ url("member/places/{$place->place_id}") }}" class="btn btn-success">เสร็จสิ้น</a>
    </div>
    <br>
