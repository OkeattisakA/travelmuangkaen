...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <strong>เพิ่มสถานที่ท่องเที่ยว</strong>
        </div>
        <div class="card-body">
            {!! Form::open(['id' => 'placeCreate','url' => 'admin/places','files' => true]) !!}
            ...
            <div class="form-group">
                {!! Form::label('place_taplace_statusgline','คำโปรย') !!} <i tabindex="0" class="fa fa-commenting" aria-hidden="true" data-toggle="popover" data-trigger="focus" data-html="true" title="ตัวอย่างคำโปรย" data-content="<img src='/img/Tagline.png' alt='' class='img-fluid'>"></i>
            ...
            <div class="form-group">
                {!! Form::submit('เพิ่มข้อมูลสถานที่ท่องเที่ยว',['class'=>'btn btn-primary']) !!}
            </div>
