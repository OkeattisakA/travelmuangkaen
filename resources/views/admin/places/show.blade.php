        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="pull-right"><a href="{{ url("admin/places/{$place->place_id}/edit") }}" class="btn btn-info"><i class="fa fa-edit" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="แก้ไข"></i></a></div>

                    @if($place->place_switch === 1)
                        <div class="pull-right"><a href="{{ url("admin/places/switch/0/{$place->place_id}") }}" class="btn btn-warning"><i class="fa fa-eye-slash" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="ปิดการแสดงผล"></i></a></div>
                    @else
                        <div class="pull-right"><a href="{{ url("admin/places/switch/1/{$place->place_id}") }}" class="btn btn-success"><i class="fa fa-eye" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="เปิดการแสดงผล"></i></a></div>
                    @endif
                            ...
                            <table id="reviewtable" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    @if($placereview->placereview_status ==1)
                                        ...
                                        <td>
                                            {!! Form::open(['method' => 'DELETE','style'=>'display:inline-block','action' => ['Admin\PlacereviewController@destroy',$placereview->placereview_id]]) !!}
                ...
                @if($place->place_status === 0)
                    <div class="text-center">
                        <a href="{{ url("admin/places/approve/{$place->place_id}") }}" class="btn btn-success">อนุมัติ</a>
                    </div>
                @else
