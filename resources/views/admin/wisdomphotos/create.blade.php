...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ url('admin/wisdomphotos') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                        ...
                        <div class="col-md-3">
                            ...
                            <div align="center">
                                ...
                                <p align="center">
                                    ...
                                    {!! Form::open(['method' => 'DELETE','action' => ['Admin\WisdomphotoController@destroy',$wisdomphoto->wisdomphoto_id]]) !!}
                                    {{ Form::hidden('wisdom_id', $wisdom->wisdom_id) }}
    ...
    <div class="text-right">
        <a href="{{ url("admin/wisdoms/{$wisdom->wisdom_id}") }}" class="btn btn-success">เสร็จสิ้น</a>
    </div>
    <br>
